...
const Cars = ({ products, website, equipamiento }) => {
    return (
...
export async function getServerSideProps(ctx) {
    ...
    return {
        props: {
            products: await Get("products/find/query?popular=false&premiunOnly=true&limit=200&isPublic=true&product_category=Accesorios para Autos").then(r => r.data).catch(() => []),
