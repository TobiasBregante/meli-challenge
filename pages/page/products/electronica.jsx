...
export async function getServerSideProps(ctx) {
    ...
    return {
        props: {
            products: await Get(`/${ctx?.locale}/products/find/query?popular=false&premiunOnly=true&limit=200&isPublic=true&product_category=Electrónica`).then(r => r.data).catch(() => []),
