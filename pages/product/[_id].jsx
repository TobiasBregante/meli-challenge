...
const ProductPage = ({ data, relateds, brandProducts, userInfo}) => {

  return (
    <Page>
      <Container lg css={{ mt: "$10" }}>
        <ProductModule data={data} relateds={relateds} brandProducts={brandProducts} userInfo={userInfo} />
      </Container>
    </Page>
  )
}
...
export async function getServerSideProps(ctx) {
  ...
  return {
    props: {
      ...
      userInfo: await Get(`user/${data.isOwnedBy}`).then(r=>r.data).catch(()=>({}))
