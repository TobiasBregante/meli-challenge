    ...
    return (
        ...
        >
            <Table.Header>
                ...
                <Table.Column>Zona y calle</Table.Column>
            ...
            <Table.Body>
                {
                    data.reverse().map((brand, i) => (
                        <Table.Row key={i}>
                            ...
                            <Table.Cell> {brand.location.zone}<br />{brand.location.street ? "Calle: " + brand.location.street  : ""} </Table.Cell>
                            <Table.Cell>
                                <Badge color={brand.isActive ? "suzccess" : "error"}>
                                    {
